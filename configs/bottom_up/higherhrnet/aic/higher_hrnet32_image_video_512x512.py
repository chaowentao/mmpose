...
#         img_prefix=f'{data_root}/val/imgs/',
#         data_cfg=data_cfg,
#         pipeline=train_pipeline),
#     val=dict(
#         type='BottomUpAicDataset',
...
# data_root = '/root/cwt1/mmpose/data/image_keypoint'
# data = dict(
#     samples_per_gpu=8,  # 24
#     workers_per_gpu=1,
#     train=dict(
...
data_root1 = 'data/image_keypoint'
data_root2 = 'data/video_keypoint'
data_root3 = 'data/aic2'
data = dict(
    samples_per_gpu=8,  # 24
    workers_per_gpu=2,
    train=[
        dict(
            type='BottomUpAicDataset',
            ann_file=f'{data_root1}/annotations/train.json',
            img_prefix=f'{data_root1}/images/',
            data_cfg=data_cfg,
            pipeline=train_pipeline),
        dict(
            type='BottomUpAicDataset',
            ann_file=f'{data_root2}/annotations/train.json',
            img_prefix=f'{data_root2}/images/',
            data_cfg=data_cfg,
            pipeline=train_pipeline)
    ],
    val=dict(
        type='BottomUpAicDataset',
        ann_file=f'{data_root1}/annotations/train2.json',
        img_prefix=f'{data_root1}/images/',
        data_cfg=data_cfg,
        pipeline=val_pipeline),
    test=dict(
